--- Firefox Add-ons / AMO — Reviewer notes (v0.8.3) ---
...
- Extension package: `rhwp-firefox-0.8.3.zip`
- Source package for AMO review: `rhwp-source-0.8.3-amo.zip`
