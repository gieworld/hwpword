...
# PR #4415 검토 - core(hwpx): Chart·OLE 캡션 파싱·재방출 유실 수정
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#4415](https://github.com/edwardkim/rhwp/pull/4415) / @humdrum00001010 |
| 관련 issue | [#4319](https://github.com/edwardkim/rhwp/issues/4319) |
| base / 원 head | `devel` / `1da7973aff1cbc3277b65cd6622fa0f3d7cdcb5e` |
| 규모 | +332 / -4, 파일 4개, commit 2개 |
...
core(hwpx): Chart·OLE 캡션 파싱·재방출 유실 수정. 원 commit은 merge commit 없이 기준 devel에서 직접 분기했다. 상세 체리픽 순서와
충돌·적용 SHA는 [#4445 통합 구현 기록](pr_4445_review_impl.md)에 기록한다.

- GitHub CI: 원 head `1da7973aff1cbc3277b65cd6622fa0f3d7cdcb5e`에서 성공을 확인했다. merge 전 최신 상태 재확인이 필요하다.
