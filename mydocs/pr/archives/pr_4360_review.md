...
# PR #4360 검토 - core: table.dirty clear 범위 한정 + 무효화 플래그 kill 범위 규칙
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#4360](https://github.com/edwardkim/rhwp/pull/4360) / @humdrum00001010 |
| 관련 issue | [#4325](https://github.com/edwardkim/rhwp/issues/4325) |
| base / 원 head | `devel` / `a10b19ecd08b7a39dcf80c9aca201e4632b9c6e6` |
| 규모 | +176 / -3, 파일 4개, commit 3개 |
...
core: table.dirty clear 범위 한정 + 무효화 플래그 kill 범위 규칙. 원 commit은 merge commit 없이 기준 devel에서 직접 분기했다. 상세 체리픽 순서와
충돌·적용 SHA는 [#4445 통합 구현 기록](pr_4445_review_impl.md)에 기록한다.

- GitHub CI: 원 head `a10b19ecd08b7a39dcf80c9aca201e4632b9c6e6`에서 성공을 확인했다. merge 전 최신 상태 재확인이 필요하다.
