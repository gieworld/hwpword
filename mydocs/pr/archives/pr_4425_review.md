...
# PR #4425 검토 - serializer(hwpx): hp:arc 왕복과 표현 불가 컨트롤 손실 경고
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#4425](https://github.com/edwardkim/rhwp/pull/4425) / @humdrum00001010 |
| 관련 issue | [#4388](https://github.com/edwardkim/rhwp/issues/4388) |
| base / 원 head | `devel` / `ba4d3ca8758ce8d97d2862ca8f2da2baf6fee0b9` |
| 규모 | +562 / -12, 파일 6개, commit 3개 |
...
serializer(hwpx): hp:arc 왕복과 표현 불가 컨트롤 손실 경고. 원 commit은 merge commit 없이 기준 devel에서 직접 분기했다. 상세 체리픽 순서와
충돌·적용 SHA는 [#4445 통합 구현 기록](pr_4445_review_impl.md)에 기록한다.

- GitHub CI: 원 head `ba4d3ca8758ce8d97d2862ca8f2da2baf6fee0b9`에서 성공을 확인했다. merge 전 최신 상태 재확인이 필요하다.
