...
# PR #4380 검토 - core: 문단 서식의 흐름 영향 술어 도입 + 머리말/꼬리말 stale 스타일 수정
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#4380](https://github.com/edwardkim/rhwp/pull/4380) / @humdrum00001010 |
| 관련 issue | [#4324](https://github.com/edwardkim/rhwp/issues/4324) |
| base / 원 head | `devel` / `be05f13f0597274a12acc4a23a633ebf8960b5b9` |
| 규모 | +433 / -11, 파일 4개, commit 4개 |
...
core: 문단 서식의 흐름 영향 술어 도입 + 머리말/꼬리말 stale 스타일 수정. 원 commit은 merge commit 없이 기준 devel에서 직접 분기했다. 상세 체리픽 순서와
충돌·적용 SHA는 [#4445 통합 구현 기록](pr_4445_review_impl.md)에 기록한다.

- GitHub CI: 원 head `be05f13f0597274a12acc4a23a633ebf8960b5b9`에서 성공을 확인했다. merge 전 최신 상태 재확인이 필요하다.
