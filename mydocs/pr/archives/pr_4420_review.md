...
# PR #4420 검토 - renderer: 접수증 날인선을 한컴 PUA 마커로 판정
...
| 항목 | 값 |
| --- | --- |
| 원 PR / 작성자 | [#4420](https://github.com/edwardkim/rhwp/pull/4420) / @humdrum00001010 |
| 관련 issue | [#4384](https://github.com/edwardkim/rhwp/issues/4384) |
| base / 원 head | `devel` / `afbb1195ed6dfb3d7f1aabff09d74fc58f46fe61` |
| 규모 | +114 / -9, 파일 3개, commit 2개 |
...
renderer: 접수증 날인선을 한컴 PUA 마커로 판정. 원 commit은 merge commit 없이 기준 devel에서 직접 분기했다. 상세 체리픽 순서와
충돌·적용 SHA는 [#4445 통합 구현 기록](pr_4445_review_impl.md)에 기록한다.

- GitHub CI: 원 head `afbb1195ed6dfb3d7f1aabff09d74fc58f46fe61`에서 성공을 확인했다. merge 전 최신 상태 재확인이 필요하다.
